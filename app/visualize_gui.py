...
class VisualizePage(tk.Tk):
    ...
    def __init__(self, parent, controller):
        ...
        self.title("Plot Inputs")
        self.config(bg="navy")
        
        '''
        # Create a canvas in the root
        canvas = tk.Canvas(self, width=200, height=800)
        ...
        #Visualization Frame
        visualization_frame = tk.Frame(self, height=500, width=500, bg="lightblue", relief='solid', borderwidth=1)
